...
[analysis.waveform_average_then_amp(m_dim_1, m_flux, m_gate, m_detuning,:), analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning,:)] = ...
    get_amp_and_phase(mean(raw_data_array.time, 1), mean(raw_data_array.voltage, 1));
...
analysis.phase_difference_both_ways(m_dim_1, m_flux, m_gate, m_detuning,:) = abs(squeeze(analysis.mean_phase_over_runs(m_dim_1, m_flux, m_gate, m_detuning,1:end/2)) - ...
    flip(squeeze(analysis.mean_phase_over_runs(m_dim_1, m_flux, m_gate, m_detuning,1+end/2 : end))));

analysis.waveform_average_then_phase_difference(m_dim_1, m_flux, m_gate, m_detuning,:) = abs(squeeze(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning,1:end/2)) - ...
...
plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2)) ...
    - input_params.fridge_attenuation - input_params.additional_attenuation, ...
    squeeze(analysis.mean_phase_over_runs(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2)), ...
    'ro', 'markerSize', 8, 'DisplayName', [temp.first_half_tag ' scan'])
hold on
plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1+end/2 : end)) ...
    - input_params.fridge_attenuation - input_params.additional_attenuation, ...
    squeeze(analysis.mean_phase_over_runs(m_dim_1, m_flux, m_gate, m_detuning, 1+end/2 : end)), ...
    'bx', 'markerSize', 8, 'DisplayName', [temp.second_half_tag ' scan'])
plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2)) ...
    - input_params.fridge_attenuation - input_params.additional_attenuation, ...
    50 + squeeze(1e3*analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2)), ...
    'r^', 'markerSize', 8, 'DisplayName', ['average then demod, ' temp.first_half_tag ' scan'])
plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1+end/2 : end)) ...
    - input_params.fridge_attenuation - input_params.additional_attenuation, ...
    50 + squeeze(1e3*analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, 1+end/2 : end)), ...
    'bv', 'markerSize', 8, 'DisplayName', ['average then demod, ' temp.second_half_tag ' scan'])
