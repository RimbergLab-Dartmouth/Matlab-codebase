...
analysis.mean_amp_all_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    mean(temp.mean_amp_averaged_points_after_demod, 1);
analysis.std_amp_all_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
...
analysis.std_phase_all_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
...
analysis.phase_difference_mean_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2/points_to_average_single_phase) = ...
...
if run_params.save_data_and_png_param == 1 || run_params.plot_visible == 1
    ...
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 : end/2))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        wrapTo180(squeeze(mean(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2), 1))), ...
        'r^', 'markerSize', 8, 'DisplayName', ['average then demod, ' temp.first_half_tag ' scan'])
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1+end/2 : end))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
