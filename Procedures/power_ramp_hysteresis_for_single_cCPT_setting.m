...
analysis.temp.mean_phase_all_points_after_demod(m_detuning, :) = wrapTo180(analysis.mean_phase_all_points_after_demod(m_detuning, :) - ...
    mean(squeeze(analysis.mean_phase_all_points_after_demod(m_detuning, :))));
...
analysis.phase_difference_mean_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2/points_to_average_single_phase) = ...
    wrapTo180(abs(squeeze(analysis.mean_phase_all_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/ ...
    2/points_to_average_single_phase)) - ...
    flip(squeeze(analysis.mean_phase_all_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning,1+run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/ ...
...
if run_params.save_data_and_png_param == 1 || run_params.plot_visible == 1
    ...
    plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2)) ...
        ...
        squeeze(1e3*mean(temp.amp_extracted(:, 1 : end/2), 1)), ...
    ...
    plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1+end/2 : end)) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        squeeze(1e3*mean(temp.amp_extracted(:, 1+end/2 : end), 1)), ...
    ...
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1+end/2 : end))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
    ...
    plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1 : end/2)) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        wrapTo180(squeeze(mean(180/pi*temp.phase_extracted(:, 1 : end/2)))), ...
        'ro', 'markerSize', 8, 'DisplayName', [temp.first_half_tag ' scan'])
    hold on
    plot(squeeze(analysis.awg_powers_dBm_corresponding_to_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1+end/2 : end)) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        wrapTo180(squeeze(mean(180/pi*temp.phase_extracted(:, 1+end/2 : end), 1))), ...
        'bx', 'markerSize', 8, 'DisplayName', [temp.second_half_tag ' scan'])
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 : end/2))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
