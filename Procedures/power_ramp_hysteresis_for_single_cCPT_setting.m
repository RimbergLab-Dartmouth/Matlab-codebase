...
analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, :) = wrapTo180(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, :) - ...
    mean(squeeze(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, :))));
...
temp.mean_phase_averaged_points_after_demod = squeeze(circ_mean(reshape(temp.phase_extracted, points_to_average_single_phase, ...
                  size(temp.phase_extracted, 1)/points_to_average_single_phase, size(temp.phase_extracted, 2)), [], 1))';
temp.mean_amp_averaged_points_after_demod = squeeze(circ_mean(reshape(temp.amp_extracted, points_to_average_single_phase, ...
                size(temp.amp_extracted, 1)/points_to_average_single_phase, size(temp.amp_extracted, 2)), [], 1))';
...
temp.powers_Vp_of_averaged_points = mean(reshape(temp.powers_Vp_sampled, points_to_average_single_phase, []), 1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% take the mean phase over all run_params.number_ramps_to_average ramps
analysis.temp.mean_amp_all_points_after_demod(m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate) = ...
    mean(temp.amp_extracted, 2);
analysis.temp.std_amp_all_points_after_demod(m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate) = ...
    std(temp.amp_extracted, [], 2);
analysis.temp.mean_phase_all_points_after_demod(m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate) = ...
    circ_mean(temp.phase_extracted, [], 2)*180/pi;
analysis.temp.mean_phase_all_points_after_demod(m_detuning, :) = wrapTo180(analysis.temp.mean_phase_all_points_after_demod(m_detuning, :) - ...
    mean(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning, :))));
analysis.temp.std_phase_all_points_after_demod(m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate) = ...
    circ_std(temp.phase_extracted, [], [], 2)*180/pi;
analysis.temp.phase_difference_mean_after_demod_all_points(m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2) = ...
    wrapTo180(abs(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2)) - ...
    flip(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning,1+run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2 : ...
    run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate)))));

temp.phase_alternate_generator (:, 1) = ...
    wrapTo180(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2)));
temp.phase_alternate_generator (:, 2) = ...
    circshift(wrapTo180(flip(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning, 1+run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2 : ...
    run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate)))), -1);
temp.phase_alternate_generator (1:2:end, :) = [];
analysis.temp.phase_alternating_after_demod_all_points(m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2) = ...
    temp.phase_alternate_generator(:);
temp = rmfield(temp, 'phase_alternate_generator');

analysis.mean_amp_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    mean(temp.mean_amp_averaged_points_after_demod, 1);
analysis.std_amp_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    std(temp.mean_amp_averaged_points_after_demod, 1);
analysis.mean_phase_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    circ_mean(temp.mean_phase_averaged_points_after_demod, [], 1)*180/pi;
analysis.mean_phase_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, :) = wrapTo180(analysis.mean_phase_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, :) - ...
    mean(squeeze(analysis.mean_phase_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, :))));
analysis.std_phase_averaged_points_after_demod(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    circ_std(temp.mean_phase_averaged_points_after_demod, [], [], 1)*180/pi;

analysis.awg_powers_Vp_corresponding_to_averaged_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    temp.powers_Vp_of_averaged_points;
analysis.awg_powers_dBm_corresponding_to_averaged_phase_data(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase) = ...
    convert_Vp_to_dBm(temp.powers_Vp_of_averaged_points);

analysis.phase_difference_mean_after_demod_averaged_points(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2/points_to_average_single_phase) = ...
    wrapTo180(abs(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/ ...
    2/points_to_average_single_phase)) - ...
    flip(squeeze(analysis.temp.mean_phase_all_points_after_demod(m_detuning,1+run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/ ...
    2/points_to_average_single_phase : run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/points_to_average_single_phase)))));

temp.phase_alternate_generator (:, 1) = ...
    wrapTo180(squeeze(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2)));
temp.phase_alternate_generator (:, 2) = ...
    circshift(wrapTo180(flip(squeeze(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning,1+run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2 : run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate)))), -1);
temp.phase_alternate_generator(1:2:end, :) = [];
analysis.alternating_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, 1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2) = ...
    temp.phase_alternate_generator(:);
...
if run_params.save_data_and_png_param == 1 || run_params.plot_visible == 1
    ...
    yyaxis right
    plot(squeeze(analysis.raw_time_data_averaged(m_dim_1, m_flux, m_gate, m_detuning,1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate))*1e6, ...
        1e3*squeeze(temp.powers_Vp_sampled)/ 10^(input_params.additional_attenuation/10))
    ...
    subplot(2, 1, 1)
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 : end/2))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        squeeze(1e3*mean(temp.amp_extracted(1 : end/2, :), 2)), ...
        'ro', 'markerSize', 8, 'DisplayName', [temp.first_half_tag ' scan'])
    hold on
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 + end/2 : end))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        squeeze(1e3*mean(temp.amp_extracted(1+end/2 : end, :), 2)), ...
        'bx', 'markerSize', 8, 'DisplayName', [temp.second_half_tag ' scan'])
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 : end/2))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...    
        squeeze(1e3*analysis.waveform_average_then_amp(m_dim_1, m_flux, m_gate, m_detuning, ...
    ...
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1+end/2 : end))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        squeeze(1e3*analysis.waveform_average_then_amp(m_dim_1, m_flux, m_gate, m_detuning, ...
        1+run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2 : run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate)), ...
    ...
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 : end/2))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        wrapTo180(squeeze(mean(180/pi*temp.phase_extracted(1 : end/2, :), 2))), ...
        'ro', 'markerSize', 8, 'DisplayName', [temp.first_half_tag ' scan'])
    hold on
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 + end/2 : end))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        wrapTo180(squeeze(mean(180/pi*temp.phase_extracted(1+end/2 : end, :), 2))), ...
        'bx', 'markerSize', 8, 'DisplayName', [temp.second_half_tag ' scan'])
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1 : end/2))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
        wrapTo180(squeeze(analysis.waveform_average_then_phase(m_dim_1, m_flux, m_gate, m_detuning, ...
        1:run_params.digitizer.data_collection_time * input_params.digitizer.sample_rate/2))), ...
        'r^', 'markerSize', 8, 'DisplayName', ['average then demod, ' temp.first_half_tag ' scan'])
    plot(convert_Vp_to_dBm(squeeze(temp.powers_Vp_sampled(1, 1, 1, 1+end/2 : end))) ...
        - input_params.fridge_attenuation - input_params.additional_attenuation, ...
