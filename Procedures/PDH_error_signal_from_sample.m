...
input_params.file_name_time_stamp = datestr(now, 'mm.dd.yy_HH.MM.SS');
...
saveas(gcf,[cd '/d' input_params.file_name_time_stamp '_error_signal_acquisition/y.fig'])
...
ylabel('Y (mV)', 'interpreter', 'latex')
saveas(gcf,[cd '/d' input_params.file_name_time_stamp '_error_signal_acquisition/xy.fig'])