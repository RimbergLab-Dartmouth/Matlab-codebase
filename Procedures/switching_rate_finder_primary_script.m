...
for m_flux = 1:2
    for m_gate = 1:2
        ...
        run_params.detuning_point_start = -16; % in MHz % do not exceed +/- 50MHz
        ...
        run_params.poissonian_lifetime_repetitions_mode = 'histogrammed_together'; % 'separate' or 'averaged', 'histogrammed_together'
        ...
        disp(['input power number = ' num2str(m_power) 13 10 ...
            ...
            'flux point number = ' num2str(m_flux) 13 10 ...
            'gate point number = ' num2str(m_gate) 13 10 ...
        ...
        data.recorded_res_freq_GHz = zeros(1, 1, run_params.detuning_array_number);
        ...
        data.recorded_res_freq_GHz = [data.recorded_res_freq_GHz; zeros(1, 1, run_params.detuning_array_number, run_params.number_repetitions)];
    ...
    while detuning_point < run_params.detuning_point_end + run_params.detuning_point_step
        ...
        while m_repetition < run_params.number_repetitions + 1
            ...
            if run_params.analysis.current_run_bistability_existence && run_params.Poisson_fig_plot_param 
                ...
                legend show
                annotation('textbox', [0.55, 0.35, 0.5, 0.3], 'String', ['Lifetime state 1 = ' num2str(round(temp.poisson_lifetime_1_us, 2)) '$\mu$ s'], ...
                    'interpreter', 'latex', 'LineStyle', 'none', 'FontSize', 30, 'Color', 'r')
                annotation('textbox', [0.55, 0.35, 0.5, 0.3], 'String', ['Lifetime state 2 = ' num2str(round(stemp.poisson_lifetime_2_us, 2)) '$\mu$ s'], ...
    ...
    if strcmp(run_params.poissonian_lifetime_repetitions_mode, 'separate') % 'separate' or 'averaged', 'histogrammed_together'
        hold on
        for m_repetition = 1 : run_parms.number_repetitions
