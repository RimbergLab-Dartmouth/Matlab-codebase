...
%%% +50, steps of 0.5
input_params.detuning_array_number = 2 * 50 / run_params.detuning_point_step + 1;
    ...
    for m_flux = run_params.m_flux : run_params.m_flux
        for m_gate = run_params.m_gate : run_params.m_gate
            ...
            elseif run_params.redo_previously_saved_run 
                disp(['suggested run_number - 1, assuming powers 1, 2, 3, 4, 5, 6, 7, 9 done = ' num2str(448 + ... 
...
%                 input_params.run_number = input_params.run_number - 1;
    ...
    %         vna_set_trigger_source(vna, 'int')
            ...
            while save_confirm ~= 1 && save_confirm ~= 101
                save_confirm = input('did the resonance freq stay stable through the run? save data? 0/1');
                if save_confirm ~=1
