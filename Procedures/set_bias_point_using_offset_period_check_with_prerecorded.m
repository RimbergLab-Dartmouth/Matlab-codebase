function[expected_bias_point_params_struct] = ...
    ...
    [~, closest_gate_point] = min(abs(desired_gate_point - pre_recorded_struct.gate_values));
    [~, closest_flux_point] = min(abs(desired_gate_point - pre_recorded_struct.flux_values));
