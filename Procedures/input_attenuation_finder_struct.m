...
input_params.ng_value = 0.56;
input_params.flux_value = 0.53;
run_params.file_name = ['fridge_attenuation_ng_0p' num2str(input_params.ng_value*100) '_flux_0p' num2str(input_params.flux_value*100)];
