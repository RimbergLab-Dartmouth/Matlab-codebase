function[err]= transmission_q_circle_error_calc_with_angle_stupid(variable_params,data_real,data_imag,freq)
...
%      data_real=data_real';
%      data_imag=data_imag';
     [theory_real, theory_imag]=transmission_q_circle_with_angle_stupid(freq,gamma_int_guess,gamma_ext_guess,freq_res_guess,angle_guess);
%      size(theory_real)
%      size(data_real)
%      size(theory_imag)
%      size(data_imag)
