...
[temp.clean_time_data, temp.raw_data_out, temp.clean_RTS_data, temp.gaussian_1_mean, temp.gaussian_2_mean, temp.sigma_double_gaussian, temp.double_gaussian_fit_error, ...
...
if run_params.save_data_and_png_param == 1
        save_file_name = [run_params.fig_directory num2str(m_power) 'dBm_' num2str(m_bias_point) ...
            '_ng_' num2str(run_params.ng_1_value) '_flux_' num2str(run_params.flux_1_value*1000) 'm_detuning_' num2str(detuning_point) 'MHz_RTS_signal.png'];
        ...
        if run_params.save_fig_file_param == 1
            save_file_name = [run_params.fig_directory num2str(m_power) '_' num2str(m_bias_point) ...
                '_ng_' num2str(run_params.ng_1_value) '_flux_' num2str(run_params.flux_1_value*1000) 'm_detuning_' num2str(detuning_point) 'MHz_RTS_signal.fig'];
            saveas(RTS_figure, save_file_name)
        end
end
clear RTS_figure ...
...
if run_params.save_data_and_png_param == 1
        save_file_name = [run_params.fig_directory num2str(m_power) 'dBm_' num2str(m_bias_point) ...
            '_ng_' num2str(run_params.ng_1_value) '_flux_' num2str(run_params.flux_1_value*1000) 'm_detuning_' num2str(detuning_point) 'MHz_RTS_PSD.png'];
        saveas(RTS_PSD_figure, save_file_name)
        save_file_name = [run_params.fig_directory num2str(m_power) '_' num2str(m_bias_point) ...
            '_ng_' num2str(run_params.ng_1_value) '_flux_' num2str(run_params.flux_1_value*1000) 'm_detuning_' num2str(detuning_point) 'MHz_RTS_PSD.fig'];
        saveas(RTS_PSD_figure, save_file_name)
end
...
if run_params.analysis.plotting_time_for_RTS ~= 0
    analysis.RTS.moving_mean_average_phase(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...
        temp.raw_data_out(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);

    data.RTS.time(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...    
        raw_data.time_corrected(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);
    
    data.RTS.raw_phase(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...
        raw_data.phase_extracted(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);

    data.RTS.raw_amp(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...
        raw_data.amp_extracted(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);

    analysis.RTS.moving_mean_average_amp(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...
        raw_data.amp_moving_mean(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);

    analysis.RTS.clean_RTS_phase(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...
        temp.clean_RTS_data(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);
    ...
    analysis.RTS.simple_threshold_clean_RTS_data(m_power, m_bias_point, m_detuning, 1 : input_params.length_of_RTS_raw_data_to_store) = ...
        temp.simple_threshold_clean_RTS_data(input_params.start_time_of_RTS_raw_data_to_store : input_params.start_time_of_RTS_raw_data_to_store + input_params.length_of_RTS_raw_data_to_store);
end
