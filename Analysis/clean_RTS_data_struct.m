disp(['cleaning RTS for repetition number ' num2str(m_repetition) ' of ' num2str(run_params.number_repetitions)])
...
%% reshape the data, and extract amp and phase
%%%% resize to a vector to feed into the digital heterodyning code
raw_data.time = raw_data_array.time(m_repetition, :);
raw_data.voltage = raw_data_array.voltage(m_repetition, :);
...
if run_params.save_data_and_png_param && temp.double_gaussian_existence
    if run_params.plot_visible == 1
...
if run_params.analysis.plotting_time_for_RTS ~= 0 && run_params.analysis.save_RTS_PSD_extended_data
...
clear moving_mean_average_time ...
      ...
      raw_data
if m_repetition == run_params.number_repetitions
