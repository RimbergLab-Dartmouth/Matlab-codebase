function [expected_res_freq] = res_freq_expected_for_Jules_sample(ng_value, flux_value)

    Ej= 14.8e9;
    Ec = 54.1e9;
    number_charge_states = 0;
    ...
    expected_res_freq = theory_freq_shift(16,16) + Jules_sample_center_freq;
