function[err]=q_circle_error_calc_with_freq_flucs(variable_params,data_real,data_imag,freq)
...
%      data_real=data_real';
%      data_imag=data_imag';
     [theory_real, theory_imag]=q_circle_with_freq_flucs(freq,gamma_int_guess,gamma_ext_guess,freq_res_guess,sigma_guess);
%      size(theory_real)
%      size(data_real)
%      size(theory_imag)
%      size(data_imag)
